...
function stampText(id, text, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => {
            var _a;
            const stream = createStampStream(client, resolve, reject);
            const info = (0, converter_1.TextStampOptionsToProto)(id, pagesInfo, options === null || options === void 0 ? void 0 : options.password, options === null || options === void 0 ? void 0 : options.options, options === null || options === void 0 ? void 0 : options.pageSelection);
            stream.write({
                info: info,
            });
...
function stampImage(id, imageBuffer, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => {
            var _a;
            const stream = createStampStream(client, resolve, reject);
            const info = (0, converter_1.ImageStampOptionsToProto)(id, pagesInfo, options === null || options === void 0 ? void 0 : options.password, options === null || options === void 0 ? void 0 : options.options, options === null || options === void 0 ? void 0 : options.pageSelection);
            stream.write({
                info: info,
            });
...
function stampBarcode(id, barcodeValue, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => {
            var _a;
            const stream = createStampStream(client, resolve, reject);
            const info = (0, converter_1.BarcodeStampOptionsToProto)(id, pagesInfo, options === null || options === void 0 ? void 0 : options.password, options === null || options === void 0 ? void 0 : options.options, options === null || options === void 0 ? void 0 : options.pageSelection);
            stream.write({
                info: info,
            });
