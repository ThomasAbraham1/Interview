...
export interface PdfiumFormFieldP {
    ...
    'pageIndex'?: (number);
    'readOnly'?: (boolean);
    'type'?: (_ironpdfengineproto_PdfiumFormFieldTypesP | null);
    'value'?: (string);
    'width'?: (number | string);
    ...
    'subType'?: "comboBoxField" | "checkBoxField" | "textField" | "unknownField";
}
export interface PdfiumFormFieldP__Output {
    ...
    'pageIndex'?: (number);
    'readOnly'?: (boolean);
    'type'?: (_ironpdfengineproto_PdfiumFormFieldTypesP__Output);
    'value'?: (string);
    'width'?: (number);
    'height'?: (number);
    'x'?: (number);
