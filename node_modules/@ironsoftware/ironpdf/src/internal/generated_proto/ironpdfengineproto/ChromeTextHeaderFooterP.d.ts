...
export interface ChromeTextHeaderFooterP {
    'leftText'?: (string);
    'centerText'?: (string);
    'rightText'?: (string);
    'drawDividerLine'?: (boolean);
    'font'?: (_ironpdfengineproto_FontTypeP | null);
...
export interface ChromeTextHeaderFooterP__Output {
    'leftText'?: (string);
    'centerText'?: (string);
    'rightText'?: (string);
    'drawDividerLine'?: (boolean);
    'font'?: (_ironpdfengineproto_FontTypeP__Output);
    'fontSize'?: (number);
    'dividerLineColor'?: (string);
}
//# sourceMappingURL=ChromeTextHeaderFooterP.d.ts.map